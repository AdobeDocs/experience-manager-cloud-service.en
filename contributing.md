...
If you are an Adobe employee and have a contribution, please use the private repository within the `AdobeDocs` org in the corporate Git.

We of course are happy for any contribution and will review your contribution if it is made on the public repository, however pull requests from Adobe employees are easier to process and can be approved faster on the private repo. Please make sure that any proprietary information is only discussed on the private repo.
