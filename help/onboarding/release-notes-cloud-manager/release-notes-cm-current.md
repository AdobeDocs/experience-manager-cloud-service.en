...
>[!NOTE]
>To see the current Release Notes for [!DNL Adobe Experience Manager as a Cloud Service](), click [here](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html).
