...
* Maven is configured at a system level with a settings.xml file which automatically includes the public Adobe **Artifact** repository. (See [Adobe Public Maven Repository](https://repo.adobe.com/) for more details).
