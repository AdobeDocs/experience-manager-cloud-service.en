...
Include the following dependencies in your project  in pom.xml:
 {link}
You can download them from:

* [MSSQL JDBC Driver](https://central.sonatype.com/artifact/com.microsoft.sqlserver/mssql-jdbc/12.8.0.jre11?smo=true)
* [OSGi JDBC Service](https://mvnrepository.com/artifact/org.osgi/org.osgi.service.jdbc/1.0.0)
...
1. Create the file:
      ...
      ```bash
      com.day.commons.datasource.jdbcpool.JdbcPoolService~<application folder>-azuresql.cfg.json
      ```
...
1. Use data bindings to connect form fields with the Azure SQL data source.
1. 
