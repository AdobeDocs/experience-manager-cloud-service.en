...
description: Use table component in AEM Forms to create tables in adaptive forms that are responsive to mobile layouts and allows using XDP table components.
