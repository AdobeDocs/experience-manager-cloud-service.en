...
1. Use the [metadata editor](/help/forms/manage-form-metadata.md) to select the custom profile that you have created above for HTML 5 forms.
1. Render your form template with custom profile and the attachments icon would appear on the forms toolbar.

   >[!NOTE]
   >
   >Out of the box, the forms portal provides a custom profile with drafts and attachments capability enabled. For more information about the **Save as Draft** profile, see [Saving HTML5 forms as a draft](/help/forms/saving-html5-form-draft.md).
...
If the mfAllowAttachments flag is turned on, the [submit service proxy service](/help/forms/service-proxy.md) also posts multipart data with dataXml and attachments.
