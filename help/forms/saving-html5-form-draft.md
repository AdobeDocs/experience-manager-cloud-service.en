...
To enable Save as Draft functionality for your existing [custom profile](/help/forms/custom-profile.md), add the following properties to your custom profile node:
