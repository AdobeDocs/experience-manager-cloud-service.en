...
<span class="preview"> For a seamless and faster integration of Adaptive forms with Adobe Analytics, visit [Enable Adobe Analytics for an Adaptive Form using Experience Cloud Setup Automation](/help/forms/forms-experience-cloud-setup-automation.md). </span>
