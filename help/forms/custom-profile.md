...
To verify your forms, **Import your forms** from your local file system to AEM Forms and [preview the form](/help/forms/previewing-forms.md) on AEM server author instance.
