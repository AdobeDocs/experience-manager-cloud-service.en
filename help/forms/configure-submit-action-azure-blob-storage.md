...
## Connect AEM Forms with Microsoft&reg; Azure Blob Storage
...
1. From the **[!UICONTROL Submit Action]** drop-down list, select **[!UICONTROL Submit to Azure Blob Storage]**.
...
1. Select the **[!UICONTROL Storage Configuration]**, where you want to save your data.
1. Click **[!UICONTROL Save&Close]** to save the Submit settings.
