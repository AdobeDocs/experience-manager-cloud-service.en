...
| AEM as a Cloud Service (Universal Editor)    | [Click here](/help/forms/configuring-submit-actions.md)        |

A Submit Action lets you choose the destination of data captured via an Adaptive Form. It is triggered when a user clicks the **[!UICONTROL Submit]** button on an Adaptive Form. Forms as a Cloud Service, for Adaptive Forms based on Core Components, offers an array of pre-built Submit Actions. 
...
## Select and configure a Submit Action for an Adaptive Form based on Core Components{#select-and-configure-submit-action}
...
You can also submit an Adaptive Form based on Core Components to other storage configurations:

* [Connect Adaptive Form to Salesforce application](/help/forms/aem-forms-salesforce-integration.md)
* [Connect an Adaptive Form to Microsoft&reg; Dynamics OData](/help/forms/ms-dynamics-odata-configuration.md)

You can [customize the default Submit Actions](/help/forms/custom-submit-action-for-adaptive-forms-based-on-core-components.md). Additionally, you can customize the Submit Actions to align with specific organizational requirements.
