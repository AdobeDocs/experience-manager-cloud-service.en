...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Supports the most commonly used XFA script constructs. For a detailed listing of supported constructs, see <a href="/help/forms/scripting-support.md">scripting support</a>.</td>
   <td>Supports all XFA script constructs.</td>
  </tr>
  <tr>
   <td>Acrobat Script APIs </td>
   <td>HTML5 forms support most commonly used APIs. For details, see <a href="/help/forms/scripting-support.md">scripting support</a>.</td>
