---
title: Add Custom Fonts to Interactive Communication Editor
description: Add Custom Fonts in Interactive Communication Editor to enable the use of custom or organization-approved fonts.
...
- Maintain brand consistency with organization-approved fonts.

- Ensure accurate PDF rendering across devices, even if the fonts aren't installed locally.

- Deliver a professional and unified communication experience.

## Add custom fonts to Interactive Communication
