...
description: Learn to use XML schema as form model in an Adaptive Form. Add special properties to fields using XML schema and limit acceptable values for an Adaptive Form.
