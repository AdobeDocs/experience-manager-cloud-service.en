...
# JWT (JSON Web Token) Authentication - Deprecated
...
The access token generated by JWT will not work after current certificates expire or March 1, 2026, whichever is earlier. Therefore, you must migrate your integration to use the new [OAuth Server-to-Server credential](/help/forms/oauth-api-authetication.md).

Migrating your projects to the OAuth Server-to-Server credential is a simple two-step process that enables a zero downtime migration for your applications and integrations. Please read the [migration guide](https://developer.adobe.com/developer-console/docs/guides/authentication/ServerToServerAuthentication/migration) to migrate to the OAuth Server-to-Server credential.
