...
1. In Adaptive Form authoring mode, select the Form Container object and select ![cmppr1](assets/configure-icon.svg) to open its properties.
...
1. Select ![check-button1](assets/save_icon.svg) to save the properties.
...
1. Open the Adaptive Form in authoring mode, select any form object, and select ![edit-rules1](assets/edit-rules-icon.svg) to open the rule editor.
