...
1. In the edit mode, select a panel, then select ![cmppr](assets/cmppr.png). In the sidebar, under Properties, enable **[!UICONTROL Make Panel Repeatable]**. Specify values for the **[!UICONTROL Maximum]** and **[!UICONTROL Minimum]** fields.
...
1. On a panel, which is to be repeated, select ![cmppr](assets/cmppr.png). You can see the panel properties in the sidebar. Enable the **Make Panel Repeatable** tab, and specify values for the **Maximum** and **Minimum** fields.
