...
role: User, Developer
---
# Submit an Adaptive Form to Microsoft&reg; OneDrive 
...
Some of the advantages of seamless integration of AEM Forms and Microsoft&reg; OneDrive are:
...
1. From the **[!UICONTROL Submit Action]** drop-down list, select **[!UICONTROL Submit to OneDrive]**.
...
1. Click **Submission** tab and select **[!UICONTROL Submit to OneDrive]**.
