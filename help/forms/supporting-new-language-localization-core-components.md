...
## Does AEM Forms support multilingual insurance use cases?

Yes. AEM Forms supports multilingual form experiences, which is important for insurers operating across regions and languages.
