...
In case you want to use a non-schema-based form fragment multiple times in an Adaptive Form, use different field names for each form fragment to avoid data duplication.
