...
## Adaptive Forms Core Components Availability

All **AEM Forms as a Cloud Service** environments include native support for creating Adaptive Forms using Core Components. For step-by-step instructions on form creation, refer to [Create an Adaptive Form](/help/forms/create-an-adaptive-form.md).

### Enabling Adaptive Forms Core Components for AEM 6.5
