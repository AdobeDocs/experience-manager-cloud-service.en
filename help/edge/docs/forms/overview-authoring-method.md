...
[WYSIWYG Authoring](/help/edge/docs/forms/universal-editor/overview-universal-editor-for-edge-delivery-services-for-forms.md) provides WYSIWYG interfaces (Universal Editor and Adaptive Forms Editor) for building forms and offers all the capabilities of Document-based Authoring, plus a wide range of additional features:
...
In essence, WYSIWYG Authoring ([Universal Editor](/help/edge/docs/forms/universal-editor/overview-universal-editor-for-edge-delivery-services-for-forms.md) and [Adaptive Forms Editor](/help/forms/creating-adaptive-form-core-components.md)) builds upon the foundation of [Document-based Authoring](/help/edge/docs/forms/create-forms.md), providing a more advanced toolkit for creating and managing complex forms. 
...
#### Comparative analysis of Edge Delivery Services Forms Authoring Methods

The following table compares the **Universal Editor (WYSIWYG)** and **Document-based Authoring** methods available in Adobe Experience Manager (AEM), highlighting key considerations to help you choose the best option.

| **Consideration**          | **Universal Editor (WYSIWYG)**                                | **Document-based Authoring**                                     |
|---------------------------|---------------------------------------------------------------|------------------------------------------------------------------|
| **Ideal For**             | Creating forms for Edge Delivery Service sites with complex requirements | Quick prototyping or basic forms without advanced submission services |
| **User Expertise**        | Business Users, Content Authors                                | Business Users                                                   |
| **Form Complexity**       | Complex forms with custom actions                              | Simple forms                                                     |
| **Design Flexibility**    | Moderate (based on templates)                                  | Limited                                                          |
| **Integration Capability**| Integrated with external systems                               | Basic (Google Sheets, Excel)                                     |
| **Publishing Method**     | Edge Delivery Services                                         | Edge Delivery Services                                           |
| **Performance & SEO**     | High Google Lighthouse scores for faster rendering and better SEO | High Google Lighthouse scores for faster rendering and better SEO |
| **Omnichannel Delivery**  | Moderate                                                      | Limited                                      |

#### Feature Comparison for Edge Delivery Services Forms Authoring Methods

The following table provides a detailed comparison of key features across different  Edge Delivery Services Forms Authoring Methods, assisting in selecting the most suitable approach for your requirements.​

| **Capability**                          | **Universal Editor (WYSIWYG)**              | **Document-based Authoring**              |
|-----------------------------------------|---------------------------------------------|-------------------------------------------|
| **Unified Composition with Sites**      | Supported ✅                                 | Not Supported ❌                          |
| **Embedding Form Support**              | Supported ✅                                 | Supported ✅                              |
| **Rules (Dynamic Behavior)**            | Advanced rules editor                        | Limited: Show/hide, compute value, custom functions |
| **Attachment Support**                  | Supported ✅                                 | ℹ️ Early Access Feature                    |
| **CAPTCHA Support**                     | reCAPTCHA Enterprise                         | reCAPTCHA Enterprise                       |
| **Submission Features**                 | Multiple options (REST, Workflow, etc.)      | Only Spreadsheet                          |
| **Data Schema**                         | FDM, Custom                                   | Custom                                     |
| **Pre-fill**                            | 💡 (via Wizard)                               | Supported ✅                              |
| **Fragments**                           | Supported ✅                                 | Supported ✅                              |
| **Visual Rule Editor**                  | Supported ✅                                 | Not Supported ❌                          |
| **Localization**                        | 💡 via Sites                                  | ℹ️ (Excel - Manual, Google Sheets Function) |
| **Data Schema (Data Tree)**             | 💡 via Universal Editor Extension             | Not Supported ❌                          |
| **Template Support**                    | Supported ✅ (Edge Delivery Services Template) | Not Supported ❌                          |
| **Forms Portal Service**                | Not Supported ❌                             | Not Supported ❌                          |
| **DoR Generation**                      | 💡 Supported                                  | Not Supported ❌                          |
| **Theme**                               | ℹ️ Customize at project level                | ℹ️ Customize at project level             |
| **Custom Component**                    | Supported ✅                                 | Supported ✅                              |
| **OOTB & Custom Functions**             | Supported ✅                                 | Supported ✅                              |
| **Experimentation/Testing**             | Supported ✅                                 | Supported ✅                              |
| **Task Management via Workfront**       | Supported ✅                                 | Not Supported ❌                          |
| **Editor Customization**                | Supported ✅ (via Universal Editor Extension) | Not Supported ❌                          |
| **Submit Action**                       | Supported ✅ (All Submit Actions)             | Only Spreadsheet                          |

Choosing the right authoring method depends on the form's purpose, complexity, and target audience. Before deciding, it's helpful to align your form requirements with the capabilities of each platform.

## Key considerations while choosing an Edge Delivery Services Forms Authoring Method

The table below highlights essential factors to consider while evaluating Document-based Authoring and WYSIWYG Authoring:
