---
title: Navigate the Universal Editor Interface for AEM Forms
description: Master the Universal Editor interface for creating AEM Forms with Edge Delivery Services. Learn essential tools, shortcuts, and workflows to build forms efficiently with this comprehensive interface guide.
keywords: universal editor, AEM forms, edge delivery services, interface guide, form authoring, WYSIWYG editor, form builder tools, user interface navigation
...
**First-time users:** Start with [Essential Tools](#essential-tools-for-form-building) to learn the core features you'll use most often.

**Experienced users:** Jump to [Advanced Features](#advanced-features-and-integrations) for specialized tools and integrations.

**Quick reference:** Use the [Interface Overview](#interface-overview) and [Keyboard Shortcuts](#keyboard-shortcuts) sections for fast lookups.

>[!NOTE]
>
> New to form authoring? See [Getting Started with Edge Delivery Services for AEM Forms](/help/edge/docs/forms/universal-editor/getting-started-universal-editor.md) for step-by-step form creation guidance.

## Interface Overview

The Universal Editor interface is organized into four main areas, each designed for specific tasks:

![Universal Editor Interface Layout](/help/edge/docs/forms/universal-editor/assets/universal-editor-interface1.png)

| **Area** | **Purpose** | **Primary Use** |
|----------|-------------|----------------|
| **[A: Experience Cloud Header](#experience-cloud-header)** | Navigation & account management | Switch between Adobe tools, access help, manage notifications |
| **[B: Universal Editor Toolbar](#universal-editor-toolbar)** | Form editing & publishing | Create, edit, preview, and publish forms |
| **[C: Properties Panel](#properties-panel)** | Component configuration | Configure form fields, manage content structure, access advanced features |
| **[D: Editor Canvas](#editor-canvas)** | Visual form building | Add components, arrange layout, see real-time preview |

**Interface Flow:** Most users work primarily in the **Editor Canvas** (D) and **Properties Panel** (C), using the **Toolbar** (B) for actions like preview and publish.
...
![Editor Canvas](/help/edge/docs/forms/universal-editor/assets/ue-editor.png)
...
The **Experience Cloud Header** provides navigation and account management tools. Most form builders use it occasionally for switching between Adobe tools or accessing help.
...
|-------------|-------------|----------------|
| **Adobe Experience Cloud** | Navigate to other Adobe tools | Switching between Sites, Assets, Forms |
| **Organization** | Switch between organizations | Multi-org access scenarios |
| **Help** | Access documentation and support | When you need guidance or want to submit feedback |
| **Notifications** | View assigned tasks and alerts | Checking workflow status |
| **Solutions** | Quick access to other Adobe solutions | Moving between different Adobe products |
| **User Profile** | Account settings and sign-out | Managing account or switching users |
...
![Preview Mode](/help/edge/docs/forms/universal-editor/assets/ue-preview.png)
...
![Home Button](/help/edge/docs/forms/universal-editor/assets/ue-home.png)
...
![Authentication Headers](/help/edge/docs/forms/universal-editor/assets/ue-authenticationheader.png)
...
![Additional Options](/help/edge/docs/forms/universal-editor/assets/ue-ellipsis.png)
...
![Add Components](/help/edge/docs/forms/universal-editor/assets/ue-add.png)
...
![Properties Mode](/help/edge/docs/forms/universal-editor/assets/ue-properties.png)
...
- **Duplicate** - Copy components quickly ![Duplicate](/help/edge/docs/forms/universal-editor/assets/ue-duplicate.png)
- **Delete** - Remove components (no confirmation prompt) ![Delete](/help/edge/docs/forms/universal-editor/assets/ue-delete.png)
...
**Learn More:** [Generate Variations Guide](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations)
...
**Purpose:** Connect with Adobe Experience Platform for tailored experiences  
...
|--------------|------------|----------------|
| `a` | Open component list | Adding new form fields |
| `d` | Open component properties | Configuring selected elements |
| `f` | Toggle content tree | Navigating complex forms |
| `p` | Toggle preview mode | Testing form functionality |
| `o` | Open form in new tab | Full-screen testing |
| `l` | Focus location bar | Switching to different forms |
...
3. **Learn form authoring** - See the [Getting Started Guide](/help/edge/docs/forms/universal-editor/getting-started-universal-editor.md)
