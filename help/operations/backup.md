...
The Recovery Time Objective (RTO) can vary, but as a general guideline, the recovery sequence takes between 60 and 90 minutes on average depending on several factors, such as repository size.
