...
|Slow Query                       | Proactive               | Fix slow queries by defining correct index definitions as suggested by the - [link to JCQ query cheet sheet](https://experienceleague.adobe.com/docs/experience-manager-65/assets/JCR_query_cheatsheet-v1.1.pdf)  