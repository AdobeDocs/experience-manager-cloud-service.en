...
| Splunk log forwarding errors    | Incident                | Check your Splunk endpoint is working and reachable from your AEM Cloud Service environment. For more information on log forwarding, please visit the [Splunk log forwarding documentation](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/developing/logging#splunk-logs). If you need assistance troubleshooting, or need to make changes to your logging configuration, please raise a support ticket with Adobe. |
