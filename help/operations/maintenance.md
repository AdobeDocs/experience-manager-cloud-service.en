...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
    ...
    <td>Adobe</td>
    <td>For existing environments (those created before November 1, 2023), purging is disabled and will not be enabled in the future unless explicitly enabled by the customer, at which time they may also configure it with custom values.<br><br> <!-- See above for the two line breaks -->New environments (those created starting November 1, 2023) will have purging enabled by default under the <code>/content</code> node of the repository according to the following behavior:
     <ol>
