...
3. Fully custom index: You can create an entirely new index from scratch. To avoid naming conflicts, use a prefix in the index name. For instance: `/oak:index/acme.product-custom-2`, where `acme.` is the prefix.
