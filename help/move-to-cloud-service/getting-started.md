...
#### Deployment/Go-Live
  ...
  4. [**Migration only**] Content transfer using packages or [Content Transfer Tool](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/overview-content-transfer-tool.md)(CTT)
