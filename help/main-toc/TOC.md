...
+ Overview {#overview}
  ...
  + {hide-from-toc} [Documentation Journeys](/help/journey-documentation/documentation-journeys.md)
...
+ Security {#security}
  ...
  + [Adobe-Managed API Integrations in Adobe Admin Console](/help/security/adobe-managed-api-integrations-in-adobe-admin-console.md)
...
+ AEMaaCS Trials {#trials}
  + Headless Trials {#headless}
    + {hide-from-toc} [Customize Content in a Sample React App](/help/trials/headless/customize-app.md)
    + {hide-from-toc} [Create the Content Structure for Your App](/help/trials/headless/content-structure.md)
    + {hide-from-toc} [Create Headless Content](/help/trials/headless/create-content.md)
    + {hide-from-toc} [Extract Content via the GraphQL API](/help/trials/headless/extract-content.md)
    + {hide-from-toc} [Fetch JSON content with JavaScript](/help/trials/headless/code-playground.md)
    + {hide-from-toc} [Edit inline with the Universal Editor](/help/trials/headless/universal-editor.md)
+ AEM as a Cloud Service Migration Journey {#migration-journey}
  ...
  + Cloud Transition Tools {#cloud-migration}
    ...
    + Content Transfer Tool {#content-transfer-tool}
      ...
      + {hide-from-toc} [Migrating Closed User Groups](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/closed-user-groups-migration.md)
...
+ Assets {#assets}
  ...
  + {hide-from-toc} [Troubleshoot AEM Assets issues](/help/assets/troubleshoot-aem-assets.md)
  ...
  + Manage digital assets {#manage}
    ...
    + {hide-from-toc} [Monitor activities and DAM tasks](/help/assets/assets-activity-history.md)
  ...
  + Dynamic Media {#dynamicmedia}
    ...
    + {hide-from-toc} [Optional - Configure Dynamic Media, General Settings](/help/assets/dynamic-media/dm-general-settings.md)
    + {hide-from-toc} [Optional - Configure Dynamic Media, Publish Setup](/help/assets/dynamic-media/dm-publish-settings.md)
    + [Troubleshoot Dynamic Media](/help/assets/dynamic-media/troubleshoot-dm.md)
    + {hide-from-toc} [Configure a Dynamic Media Alias Account](/help/assets/dynamic-media/dm-alias-account.md)
    ...
    + {hide-from-toc} [Request error report for failed delivery URLs](/help/assets/dynamic-media/reporting-dm.md)
    ...
    + Dynamic Media with OpenAPI capabilities {#dynamic-media-open-apis}
      ...
      + [Content Credentials](/help/assets/content-credentials-dynamic-media-openapi.md)
...
+ Forms {#forms}
  + Overview {#forms-overview}
    ...
    + {hide-from-toc} [Introduction2](/help/forms/home2.md)
    + {hide-from-toc} [Introduction3](/help/forms/home3.md)
  ...
  + Setup and migrate {#setup-configure-migrate}
    ...
    + {hide-from-toc} [Enable Adaptive Forms Core Components on AEM Forms as a Cloud Service and local development environment](/help/forms/enable-adaptive-forms-core-components.md)
  ...
  + Getting Started {#getting-started-forms}
    + {hide-from-toc} [Use Case and setup development environment](/help/forms/create-adaptive-form-tutorial-getting-started.md)
    + {hide-from-toc} [Create the loan application form](/help/forms/create-adaptive-form-tutorial.md)
  + Integrate {#integrate}
    + Services {#services}
    ...
    + Form Data Model {#use-form-data-model}
      ...
      + {hide-from-toc} [Design XML Schema for an Adaptive Form](/help/forms/adaptive-form-xml-schema-form-model.md)
  ...
  + Adaptive Forms {#adaptive-forms-authoring}
    + {hide-from-toc} [Create an Adaptive Form](/help/forms/create-an-adaptive-form.md)
    + {hide-from-toc} [Which Adaptive Forms are best for you?](/help/edge/docs/forms/authoring-a-form.md) 
    ...
    + Foundation Components {#authoring-adaptive-forms-foundation-components}
      ...
      + Create an Adaptive Form {#create-an-adaptive-form-on-forms-cs}
        ...
        + {hide-from-toc} [Authoring in-context help for form fields](/help/forms/authoring-in-field-help.md)
        ...
        + {hide-from-toc} [Reference Adaptive Form Fragments](/help/forms/reference-adaptive-form-fragments.md)
        + {hide-from-toc} [Synchronizing Adaptive Forms with XFA Form Templates](/help/forms/synchronizing-adaptive-forms-xfa.md)
        + {hide-from-toc} [XFA support in XDP-based Adaptive Forms](/help/forms/xfa-api-supported-in-adaptive-form.md)
      ...
      + Add rules and use expressions in an Adaptive Form {#add-rules-and-use-expressions-in-an-adaptive-form}
        ...
        + {hide-from-toc} [Grant rule editor access to select user groups](/help/forms/rule-editor-access-user-groups.md)
        + [Using SOM expressions in Adaptive Forms](/help/forms/using-som-expressions-adaptive-forms.md)
        + {hide-from-toc} [Adaptive Form Expressions](/help/forms/adaptive-form-expressions.md)
      ...
      + Configure Submit Actions and metadata submission {#configure-submit-actions-and-metadata-submission}
        ...
        + {hide-from-toc} [Add information from user data to form submission metadata](/help/forms/form-submission-metadata.md)
        + {hide-from-toc} [API to invoke Form Data Model (FDM) service from Adaptive Forms](/help/forms/invoke-form-data-model-services.md)
      ...
      + {hide-from-toc} [Associate submission reviewers with a form](/help/forms/adding-reviewers-form.md)
      + {hide-from-toc} [Create and manage reviews for an Adaptive Form](/help/forms/review-adaptiveforms-in-sites-page.md)
  ...
  + HTML5 Forms {#html5-forms}
    ...
    + {hide-from-toc} [Architecture of HTML5 forms](/help/forms/html5-forms-architecture.md)
    ...
    + {hide-from-toc} [Saving an HTML5 form as a draft](/help/forms/saving-html5-form-draft.md)
    ...
    + {hide-from-toc} [Form set in AEM Forms](/help/forms/formset-in-aem-forms.md)
...
+ Forms Centric Workflows {#create-form-centric-workflows}
    ...
    + {hide-from-toc} [Dynamic User or Group Selection in AEM Workflow](/help/forms/dynamically-select-a-user-or-group-for-aem-workflow.md)
    + {hide-from-toc} [Manage Forms applications and tasks in AEM Inbox](/help/forms/manage-applications-inbox.md)
...
+ Content and Commerce {#content-and-commerce}
  ...
  + Edge Delivery Services Storefront {#edge-storefront}
    + {hide-from-toc} [Introduction](/help/commerce-cloud/edge-storefront/introduction.md)
  + Third Party Storefront {#thrid-party-storefront}
    + {hide-from-toc} [Introduction](/help/commerce-cloud/third-party-storefront/introduction.md)
...
+ Edge Delivery Services {#edge-delivery}
  ...
  + Building Forms {#build-forms}
    ...
    + WYSIWYG Authoring {#universal-editor}
      ...
      + {hide-from-toc} [Create Salesforce Lead Object using API Integration](/help/edge/docs/forms/universal-editor/create-lead-object-using-api-integration.md)  
    ...
    + Document-based authoring {#getting-started-edge-delivery-services-forms}
      ...
      + {hide-from-toc} [Form Field Validation: Add Error Checks to Your Forms](/help/edge/docs/forms/validate-forms.md)
      ...
      + {hide-from-toc} [Advanced Form Validation: Regular Expression Guide](/help/edge/docs/forms/regex-forms.md)
      + {hide-from-toc} [Build Reusable Forms: Guide to Form Fragments](/help/edge/docs/forms/form-fragments.md)
      ...
      + {hide-from-toc} [Build Custom Form Components: Developer's Guide](/help/edge/docs/forms/custom-components-forms.md)
      + {hide-from-toc} [Monitor Form Performance: Operational Telemetry Guides](/help/edge/docs/forms/operational-telemetry-for-forms.md) 
  ...
  + {hide-from-toc} [Best Practices for creating forms](/help/edge/docs/forms/universal-editor/best-practices-eds-forms.md)
+ Headless {#headless}
...
+ Implementing {#implementing}
  ...
  + Use Cloud Manager {#using-cloud-manager}
    ...
    + Reports {#reports}
      ...
      + {hide-from-toc} [Visual Comparison](/help/implementing/cloud-manager/reports/report-visual-comparison.md)
  ...
  + Content Delivery Overview {#content-delivery}
    ...
    + {hide-from-toc} [Validating and Debugging using Dispatcher Tools Legacy](/help/implementing/dispatcher/validation-debug-legacy.md)
