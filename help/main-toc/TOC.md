...
+ Sites {#sites}
  ...
  + Authoring {#authoring}
    ...
    + Sites Console {#console}
      + [The Sites Console](/help/sites-cloud/authoring/console/sites-console.md)
      + [Console Side Panel](/help/sites-cloud/authoring/console/console-side-panel.md)
      + [Creating a New Site](/help/sites-cloud/authoring/console/create-site.md)
      + [Creating and Organizing Pages](/help/sites-cloud/authoring/console/organizing-pages.md)
      + [Page Properties](/help/sites-cloud/authoring/console/page-properties.md)
      + [Previewing Pages](/help/sites-cloud/authoring/console/previewing-content.md)
      + [Publishing Pages](/help/sites-cloud/authoring/console/publishing-pages.md)
      + [Page Templates](/help/sites-cloud/authoring/console/templates.md)
      + [Page Versions](/help/sites-cloud/authoring/console/page-versions.md)
      + [Page Diff](/help/sites-cloud/authoring/console/page-diff.md)
      ...
      + [Enabling Progressive Web App Features](/help/sites-cloud/authoring/console/enable-pwa.md)
      + [Keyboard Shortcuts](/help/sites-cloud/authoring/console/keyboard-shortcuts.md)
      + [Export to CSV](/help/sites-cloud/authoring/console/csv-export.md)
    + Page Editor {#editor}
      + [The Page Editor](/help/sites-cloud/authoring/editor/page-editor.md)
      + [Editor Side Panel](/help/sites-cloud/authoring/editor/editor-side-panel.md)
      + [Editing Pages](/help/sites-cloud/authoring/editor/edit-content.md)
      + [Adding Page Annotations](/help/sites-cloud/authoring/editor/annotations.md)
      + [The Rich Text Editor](/help/sites-cloud/authoring/editor/rich-text-editor.md)
      + [Components](/help/sites-cloud/authoring/editor/components.md)
      + [Authoring for Mobile Devices](/help/sites-cloud/authoring/editor/mobile.md)
      + [Creating Accessible Content (WCAG 2.1 Conformance)](/help/sites-cloud/authoring/editor/accessible-content.md)
      + [Keyboard Shortcuts](/help/sites-cloud/authoring/editor/keyboard-shortcuts.md)
      + [Style System](/help/sites-cloud/authoring/editor/style-system.md)
    + Fragments {#fragments}
