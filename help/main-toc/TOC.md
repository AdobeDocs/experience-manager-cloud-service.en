...
+ Implementing {#implementing}
  ...
  + Using Cloud Manager {#using-cloud-manager}
    ...
    + Managing your Code {#managing-code}
      ...
      + [Add an External Repository](/help/implementing/cloud-manager/managing-code/onboard-external-repositories.md)
    ...
    + Cloud Manager CI-CD Pipelines {#cicd-pipelines}
      ...
      + [Split Stage-Only and Prod-Only Pipelines](/help/implementing/cloud-manager/configuring-pipelines/stage-prod-only.md)
