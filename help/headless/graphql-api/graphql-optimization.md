...
* If the publish memory remains high, set a positive maximum size for `AEM_HEADLESS_GRAPHQL_BOUNDED_DATA_CACHE_MAXIMUM_SIZE`, then tune based on your workload.
