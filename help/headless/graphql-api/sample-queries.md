...
>[!NOTE]
>
>Depending on your instance you can directly access the [Graph*i*QL interface included with AEM GraphQL API](/help/headless/graphql-api/content-fragments.md#graphiql-interface) for submitting and testing queries.
>
