...
description: Learn about Adobe Experience Manager (AEM) as a Headless CMS with a combination of detailed documentation and headless journeys. Learn how features like Content Models, Content Fragments, and a GraphQL API are used to power headless experiences with AEM.
...
You can read the detailed documentation of all the features and/or follow the selection of [headless journeys as a quick-start](#first-steps).
