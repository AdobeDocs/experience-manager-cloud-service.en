...
|2|[AEM as a Cloud Service Terminology](/help/journey-onboarding/terminology.md)|Before you sign into AEMaaCS for the first time, it is helpful to understand some of the terminology of the system and its basic structure.|
...
|3|[Assigning Product Profiles](/help/journey-onboarding/profiles.md)|Review Cloud Manager Product Profiles and learn how to assign team members to Cloud Manager Product profiles.|
