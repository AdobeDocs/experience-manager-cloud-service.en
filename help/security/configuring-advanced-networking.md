...
>[!INFO]
>
>If a dedicated egress IP is configured, Splunk forwarding will continue to use the dynamic egress ranges. Splunk forwarding can not be configured to use a dedicated egress IP.
