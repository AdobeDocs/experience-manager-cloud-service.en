...
This alert is enabled by default, but it can be disabled using the *enable_ddos_alerts* property, set to false. Once the alert is triggered, it will not fire off again until the next day (UTC).
