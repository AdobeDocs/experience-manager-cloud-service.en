...
* [Select the content you want to work with](#select-the-content) - from existing blocks of content
* [Describe the changes you want](#describe-the-changes-you-want)
* Generate variations of your content
* Select and use the appropriate variation
* Review your history
* Save your favorites
