...
* [Creating and Organizing Pages](/help/sites-cloud/authoring/sites-console/organizing-pages.md) - This guide details how to manage pages of your AEM Site if you want to customize it further after creating it from the template.
