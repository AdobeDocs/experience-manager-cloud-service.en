...
1. Here you see the language root folder and all other language folders. Select the localized language or languages that you want to publish.
![Select language folder](assets/select-language-folder.png)
1. Select **Manage Publication**.
1. In the **Manage Publication** window, make sure that **Publish** is automatically selected under **Action** and that **Now** is selected under **Scheduling**. Select **Next**.
![Manage publication options](assets/manage-publication-options.png)
1. In the next **Manage Publication** window, confirm that the proper path(s) is/are selected. Select **Publish**.
...
1. In the **Project** drop-down list, select **Add to an existing Translation Project**.
1. In the **Existing Translation Project** drop-down list, select the project created for the initial translation.
1. Select **Update**.
...
1. Select the project that you just updated.
1. Select the language or one of the languages that you updated.
...
1. Navigate to **Navigation** &gt; **Projects**.
1. Select the project that you need to update.
1. Select the **Add** button at the top of the window.
1. In the **Add Tile** window, select **Translation Job** and then **Submit**.

   ![Add tile](assets/add-translation-job-tile.png)

1. On the card of the new translation job, select the chevron button at the top of the card, and select **Update Target** to define the target language of the new job.

   ![Update target](assets/update-target.png)

1. In the **Select Target Language** dialog, use the drop-down to select the language and select **Done**.
...
* [Publishing Pages](/help/sites-cloud/authoring/console/publishing-pages.md) - Learn about the additional features available when publishing content. This document is focused on authoring pages rather than Content Fragments, but the theory still applies.
