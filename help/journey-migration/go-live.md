...
* Understand the Admin Console, and use it to prepare users and groups so that they are ready after the content migration.  See [Managing Principals](/help/journey-migration/managing-principals.md) for more information.
