...
* `Mongo server selection error` - This is a rare client-side timeout error that can occur for a number of underlying reasons. A subsequent retry will most likely correct the issue.
