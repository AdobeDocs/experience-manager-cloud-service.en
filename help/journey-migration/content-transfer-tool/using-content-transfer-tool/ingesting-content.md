...
* `Mongo network error` - At times establishing a connection to mongo can fail to occur causing the ingestion process to exit early and report it as failed. A simple retry of the ingestion should be attempted.
