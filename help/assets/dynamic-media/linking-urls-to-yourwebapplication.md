...
1. Near the upper-left corner of the page, tap **[!UICONTROL Cloud Services]**, then tap the Experience Manager icon and navigate to **[!UICONTROL General]** > **[!UICONTROL CRXDE Lite]**.
