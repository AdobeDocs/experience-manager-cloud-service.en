...
## Selectively publish assets to Dynamic Media or AEM as a Cloud Service using Manage Publication{#selective-publish-manage-publication}

Before you can use **[!UICONTROL Manage Publication]** to selectively publish assets to Dynamic Media or to AEM, be sure you have either set the **[!UICONTROL Publish Assets]** option in **[!UICONTROL Dynamic Media Configuration]** to **[!UICONTROL Selective Publish]** or configured selective publishing at the folder level.
...
**To selectively publish assets to Dynamic Media or AEM as a Cloud Service using Manage Publication**
...
1. In AEM, in the upper-left corner of the page, tap the AEM logo to access the global navigation console. On the left side of the page, tap the Navigation icon (just above the Tools icon), then tap **[!UICONTROL Assets > Files.]**
...
Optionally, you can use these check boxes in conjunction with the **[!UICONTROL Publish]** search predicate to refine the search results of **[!UICONTROL Published]** and **[!UICONTROL Unpublished]** AEM assets.
1. Do one of the following:
...
1. On the **[!UICONTROL Manage Publication - Options]** page, select the desired action.
    ...
    | --- | --- | --- |
    | Publish | Immediately or Upon Activation | Published to AEM and Dynamic Media. |
    | Publish | Selective Publish | Published to AEM only. |
...
1. (Optional) In the **[!UICONTROL Manage Publication - Scope]** page, review the **[!UICONTROL Publish Target]** column in the table for the selected assets. 
    ...
    | --- | --- | --- |
    | Immediately or <br>Upon Activation | Publish | AEM and Dynamic Media |
    | Immediately or <br>Upon Activation | Publish to Dynamic Media | None |
    | Selective Publish | Publish | AEM |
    | Selective Publish | Publish to Dynamic Media | Dynamic Media |
    | Immediately or <br>Upon Activation | Unpublish | AEM and Dynamic Media |
