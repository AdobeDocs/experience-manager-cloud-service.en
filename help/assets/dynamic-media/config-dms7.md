...
See [Uploading Assets](/help/assets/dynamic-media/managing-assets-touch-ui.md#uploading-assets).
...
1. On the right side of the CRXDE Lite page, in the lower portion:
    ...
    * double-click **[!UICONTROL jobParam]** to open its associated text field. See [Supported Mime Types](/help/assets/dynamic-media/assets-formats.md#supported-mime-types) for a list of permitted processing parameter values you can use for a given mime type.
