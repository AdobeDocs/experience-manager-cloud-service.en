...
>
>* You have [enabled Dynamic Media](/help/assets/dynamic-media/config-dynamic.md). Dynamic Media is disabled by default.
...
**[!UICONTROL Image Modifiers]** &ndash; You can change image effects by supplying additional image commands. These are described in [Managing Image Presets](/help/assets/dynamic-media/managing-viewer-presets.md) and the [Command reference](https://marketing.adobe.com/resources/help/en_US/s7/is_ir_api/is_api/http_ref/c_command_reference.html).
...
**[!UICONTROL Viewer preset]** &ndash; Select an existing video viewer preset from the drop-down menu. If the viewer preset you are looking for is not visible, you may need to make it visible. See [Managing Viewer Presets](/help/assets/dynamic-media/managing-viewer-presets.md).
