...
>
>* See [Configuring Dynamic Media Cloud Services](/help/assets/dynamic-media/config-dms7.md#configuring-dynamic-media-cloud-services) in Configuring Dynamic Media - Scene7 mode and [Troubleshooting Dynamic Media - Scene7 mode.](/help/assets/dynamic-media/troubleshoot-dms7.md)
>
>* See [Configuring Dynamic Media Cloud Services](/help/assets/dynamic-media/config-dynamic.md#configuring-dynamic-media-cloud-services) in Configuring Dynamic Media - Hybrid mode.
>
...
* To configure YouTube in AEM before 6.4, see [Setting up YouTube in AEM before 6.4](/help/assets/dynamic-media/video.md#setting-up-youtube-in-aem-before).
...
See also [Configuring Dynamic Media Cloud Services](/help/assets/dynamic-media/config-dynamic.md).
...
See also [About video thumbnails in Dynamic Media - Scene7 mode](/help/assets/dynamic-media/video.md#about-video-thumbnails-in-dynamic-media-scene-mode).
