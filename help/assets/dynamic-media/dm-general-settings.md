...
The maximum number of pages for a PDF to be considered for extraction is 5000 for new uploads. This limit will change to 100 pages on December 31, 2022. See also [Dynamic Media limitations](/help/assets/dynamic-media/limitations.md).
