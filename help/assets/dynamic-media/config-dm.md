...
With the new architecture, AEM is responsible for primary assets and synchs with Dynamic Media for asset processing and publishing:

1. When the primary asset is uploaded to AEM, it is replicated to Dynamic Media. At that point, Dynamic Media handles all asset processing and rendition generation, such as video encoding and dynamic variants of an image.
