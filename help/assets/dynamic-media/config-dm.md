...
1. When the connection is successful, you can set the following:
   ...
   |---|---|
   | Company | The name of the Dynamic Media account. You can have one Dynamic Media account in Experience Manager.<!-- CQDOC-19579 and CQDOC-19612 --><br>See also [Configure a Dynamic Media company alias account](/help/assets/dynamic-media/dm-alias-account.md). |
