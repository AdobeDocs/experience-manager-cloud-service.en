...
1. In the **[!UICONTROL Configuring Dynamic Media]** dialog box, select **[!UICONTROL OK]** to begin the configuration.
   ...
   > See [Troubleshoot a new Dynamic Media configuration](#troubleshoot-dm-config) and [Your Inbox](/help/sites-cloud/authoring/getting-started//help/sites-cloud/authoring/inbox.md) for more information. 
...
See also [Your Inbox](/help/sites-cloud/authoring/getting-started//help/sites-cloud/authoring/inbox.md).
