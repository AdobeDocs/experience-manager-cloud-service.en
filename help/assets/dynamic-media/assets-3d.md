...
See also [3D formats supported](/help/assets/file-format-support.md#supported-3d-formats)
...
Before you work with 3D assets in Dynamic Media, make sure that your AEM administrator has already enabled and configured Dynamic Media Cloud Services.
