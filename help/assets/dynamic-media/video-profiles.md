...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><code>String</code></td>
   <td><p>Positive number.</p> <p>Default is 300.</p> <p>Recommended value for HLS or DASH (adaptive streaming) is 60-90. (To see or use DASH, it must first be enabled by Adobe Technical Support on your account. See [Enable DASH on your account](#enable-dash).)</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><code>String</code></td>
   <td><p><code>true</code>/<code>false</code></p> <p>Default is <code>false</code>.</p> <p>Recommended value for HLS or DASH is <code>false</code>. (To see or use DASH, it must first be enabled by Adobe Technical Support on your account. See [Enable DASH on your account](#enable-dash).)</p> <p> </p> </td>
  </tr>
 </tbody>
</table>
