...
>[!NOTE]
>
>For information on the Assets user interface, see [Managing assets with the Touch UI](/help/assets/dynamic-media/managing-assets-touch-ui.md).
...
If you need to, you can edit [Mixed Media Sets](#editing-mixed-media-sets). In addition, you can view and modify [Mixed Media Set properties](/help/assets/dynamic-media/managing-assets-touch-ui.md#editing-properties).
