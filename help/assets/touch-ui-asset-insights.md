...
1. To obtain the embed code for the asset that you include in websites to gets performance data, tap/click **Get Embed Code** below the asset thumbnail. 

<!--
For more information on how to include your Embed code in third-party web pages, see <!--[Using Page Tracker and Embed code in web pages](/help/assets/touch-ui-using-page-tracker.md).
-->
