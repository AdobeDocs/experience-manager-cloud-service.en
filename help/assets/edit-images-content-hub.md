...
Users with entitlements to access Adobe Express and AEM Assets Content Hub, and who have the rights to remix assets to new variations, can edit images using Content Hub.

### How do I edit an image using Adobe Express in AEM Assets Content Hub?

To edit an image, click **Open in Adobe Express** on the asset card of the image or open the image's details and click the Adobe Express logo. This loads the embedded Adobe Express editor within AEM Assets Content Hub, allowing you to make your edits without leaving the platform.

### What editing features does Adobe Express provide within AEM Assets Content Hub?

Adobe Express offers a variety of image-editing features, including resizing images, removing or changing background color, cropping images, and combining them with AI-generated images or text, among other capabilities.

### Which file formats can I save my edited images as in AEM Assets Content Hub?

You can save your edited images in PNG (good quality), JPG (suitable for small files), or PDF (suitable for documents) formats.

### What fields should I fill when saving an edited image in Content Hub?

When saving an edited image, you should specify a name for the asset in the **Save as** field and a campaign name in the **Campaign name** field. Adobe also recommends specifying values in additional fields such as Keywords, Channels, Timeframe, and Region to enhance searchability and organization.

### Can I save my edits as a new asset in Content Hub?

Yes, after editing, you can click **Save as new asset** to save your changes as a new asset in Content Hub.
