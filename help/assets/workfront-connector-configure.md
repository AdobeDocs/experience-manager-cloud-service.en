...
Adobe Experience Manager as a Cloud Service administrators configure the enhanced connector after installing it. For instructions to install, see [Install enhanced connector](/help/assets/workfront-integrations.md).
