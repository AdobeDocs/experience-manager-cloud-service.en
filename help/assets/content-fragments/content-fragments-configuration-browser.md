...
>* you will not be able to [select the Sites configuration to create the related end-point](/help/headless/graphql-api/content-fragments.md#enabling-graphql-endpoint).
