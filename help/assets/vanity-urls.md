...
description: Learn to transform your long asset delivery URLs into short, branded vanity URLs using Dynamic Media OpenAPI capabilities. Vanity URLs let you customize long, complex, hard-to-remember web addresses into shorter, SEO-friendly, easy-to-remember links. Use your brand name, product names, and relevant keywords in the vanity URL to boost brand visibility and user engagement
role: Admin
...
Transform your long asset delivery URLs into short, branded vanity URLs using [!DNL Dynamic Media OpenAPI capabilities]. [!DNL Vanity URLs] let you customize long, complex, hard-to-remember web addresses into shorter, SEO-friendly, easy-to-remember and share URLs. System-generated asset UUIDs makes your asset delivery URL complex. Vanity URLs replaces these UUIDs with short, readable identifiers. Use your brand name, product names, and relevant keywords in the vanity URL to boost brand visibility and user engagement. 
...
* **Improves user engagement:** Branded URLs build user confidence and trust. Users are more likely to click on professional, branded links, resulting in higher click-through rates.
...
### Best Practices for Vanity URLs{#best-practices-for-creating-vanity-urls}
