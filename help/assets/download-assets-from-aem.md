...
By default, [!DNL Experience Manager] triggers a notification in the [[!DNL Experience Manager] Inbox](/help/sites-cloud/authoring/getting-started//help/sites-cloud/authoring/inbox.md) upon generation of a download archive.
