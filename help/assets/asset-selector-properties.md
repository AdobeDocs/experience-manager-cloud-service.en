...
| *uploadConfig* | Object | | | It is an object that contains customized configuration for the upload. See [upload configuration](#asset-selector-customization.md#upload-config) for the usability.|
