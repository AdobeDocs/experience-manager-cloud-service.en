...
seo-title: Publish assets, folders, and collecetions to Brand Portal
description: Learn how to publish and unpublish assets, folders, and collections to Brand Portal.
seo-description: Learn how to publish and unpublish assets, folders, and collections to Brand Portal.
uuid:
...
# Publish assets, folders, and collections to Brand Portal {#publish-aem-assets-to-brand-portal}
...
1. Following are the two ways to publish assets:
    * [Publish now](#publish-to-bp-now) (Publish assets immediately)
    * [Publish later](#publish-to-bp-now) (Schedule publishing assets)
...
* From the toolbar, select **[!UICONTROL Manage Publication]**.
  ...
  1. From **[!UICONTROL Action]**, select **[!UICONTROL Publish to Brand Portal]**, and from **[!UICONTROL Scheduling]**, select **[!UICONTROL Now]**. Click **[!UICONTROL Next]**.
...
Login to the Brand Portal interface to see the published assets are available.
...
1. **Publish folders now**
    ...
    * From the toolbar, select **[!UICONTROL Quick Publish]**. From the menu, select **[!UICONTROL Publish to Brand Portal]**.

    * From the toolbar, select **[!UICONTROL Manage Publication]**.

      1. From **[!UICONTROL Action]**, select **[!UICONTROL Publish to Brand Portal]**. From **[!UICONTROL Scheduling]**, select **[!UICONTROL Now]**. Click **[!UICONTROL Next]**.
...
You can remove any asset folder published to Brand Portal by unpublishing it from your AEM Assets instance. After you unpublish the original folder, its copy is no longer available to the Brand Portal users.

You can unpublish asset folders from Brand Portal immediately, or schedule it for a later date and time. 

To unpublish asset folders from Brand Portal:

1. From the AEM Assets console, select the folder that you want to unpublish.
...
1. **Unpublish from Brand Portal now**
   ...
   To immediately unpublish the selected folder from Brand Portal:

    1. From the toolbar, select **Manage Publication**.
    1. From **Action**, select **Unpublish from Brand Portal**, and from **Scheduling**, select **Now**. Click **Next.**
    1. Confirm your selection in **Scope** and click **Unpublish from Brand Portal**.

   ![confirm-unpublish](assets/confirm-unpublish.png)

1. **Unpublish from Brand Portal later**

   To schedule unpublishing of a folder from Brand Portal to a later date and time:
...
You can publish or unpublish collections from your AEM Assets instance.

>[!NOTE]
>
>Content fragments cannot be published to the Brand Portal. Therefore, if you select content fragment(s) in AEM Asset, then **[!UICONTROL Publish to Brand Portal]** action is not available.
>
>If collections containing content fragments are published from AEM Assets to Brand Portal, then all the content of the folder except content fragments is replicated to Brand Portal interface.

### Publish collections {#publish-a-collection-to-brand-portal}
...
1. Close the confirmation message.
   ...
   Login to Brand Portal as an administrator. The published collection is available in the **[!UICONTROL Collections]** console.
...
Following are the steps to unpublish collections: 

1. From the Collections console of your AEM Assets instance, select the collection that you want to unpublish.
