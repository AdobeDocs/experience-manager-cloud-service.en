...
> For [!DNL Experience Manager Assets] as a [!DNL Cloud Service], the transfer rate observed under lab condition 1000 assets per hour. The rate is observed with an average size of 10 MB assets.
