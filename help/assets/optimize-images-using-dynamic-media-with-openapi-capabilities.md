...
[!DNL Image Presets] provide several advantages for managing and delivering images in Dynamic Media with OpenAPI. Some of the key benefits include the following:
...
**Use presets during authoring in AEM Sites**: Authors can select [!DNL Image Presets] during page editing in AEM Sites authoring page when Dynamic Media support is enabled. Execute the following steps to use image presets in your authoring page:
