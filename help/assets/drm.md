...
>
>If you create or modify licence pages, or port them from previous AEM releases, Adobe recommends that you store the pages at `/apps/settings/dam/drm/licenses` or `/conf/*/settings/dam/drm/licenses`.

### Download DRM assets {#downloading-drm-assets}
