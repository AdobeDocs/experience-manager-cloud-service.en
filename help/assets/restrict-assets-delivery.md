...
To restrict the delivery of assets, roles must be configured for the assets within the [!DNL Experience Manager] or [!DNL Experience Manager Assets]. To configure roles in [!DNL Experience Manager], follow these steps:
...
#### Delivery for AEM author or Asset Selector {#delivery-aem-author-asset-selector}
...
#### Delivery for custom identity providers {#delivery-custom-identity-provider}
