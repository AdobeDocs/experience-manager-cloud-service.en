...
description: Learn to integrate [!DNL AEM Assets] with [!DNL Figma] and use [!DNL AEM] assets in [!DNL Figma] through an asset selector panel in [!DNL Figma].  
hide: no
role: User
---
...
Integrate [!DNL AEM Assets] with [!DNL Figma] to get an asset selector panel in [!DNL Figma]. Use this asset selector panel to access to the [!DNL AEM Assets] and use them in your [!DNL Figma] design workflow.
