...
2. Select **[!UICONTROL Publish to AEM and Dynamic Media]** and click **[!UICONTROL Upload]**. The assets are published to [!DNL AEM and Dynamic Media] at the same time. To see the updated publish status for these assets, see [Check Publish status](#check-publish-status). 
...
2. Select **Publish to AEM** to publish the uploaded assets to [!DNL AEM] and click **[!UICONTROL Upload]**.
...
### [!UICONTROL Dynamic Media Publish Mode] set to [!UICONTROL Selective Publish] {#dynamic-media-publish-mode-set-to-selective-publish}
 ...
 To publish assets during upload to a folder with [!UICONTROL Dynamic Media Publish Mode] set to **[!UICONTROL Selective Publish]**:
  ...
  2. Select **[!UICONTROL Publish to AEM]**, **[!UICONTROL Publish to Dynamic Media]**, or both as per your requirements and click **Upload**. 
...
## Publish assets using asset browse page {#publish-assets-using-asset-browse-page}
 ...
 2. Select one or more assets or folders that you need to publish and click **[!UICONTROL Publish]**.
 3. Select **[!UICONTROL AEM]** and click **[!UICONTROL Publish]** to publish assets to [!DNL AEM and Dynamic Media].
...
## Publish assets using search results page {#publish-assets-using-search-results-page}
 ...
 2. Select the assets that you need to publish and click **[!UICONTROL Publish].**
 3. Select [!DNL AEM, Dynamic Media], or both as per your requirements and click **[!UICONTROL Publish]**. 
...
1. Click **[!UICONTROL Assets]** in the **[!UICONTROL Assets Management]** section available in the left pane. 
2. Switch to List view using the View Switcher. You can view asset properties, such as [!UICONTROL AEM publish], [!UICONTROL Dynamic Media Publish], [!UICONTROL title], [!UICONTROL size], [!UICONTROL dimensions], and so on.  
...
![check publish status1](/help/assets/assets/check-publish-status1.png)
  If you cannot view the [!DNL AEM] Publish and [!DNL Dynamic Media] Publish columns in the List view: 
   ...
   2. Click **[!UICONTROL Confirm]**. [!DNL Experience Manager Assets] adds the selected columns to the List view. 
