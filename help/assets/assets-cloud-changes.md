...
| Subasset generation for or annotating of a compound assets | Not supported. | Dependent use cases may not be fulfilled. See [subasset creation in [!DNL Experience Manager] 6.5](https://experienceleague.adobe.com/docs/experience-manager-65/assets/managing/managing-linked-subassets.html#generate-subassets). |
