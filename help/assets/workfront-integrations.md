...
>
>* Adobe supports enhanced connector versions 1.7.4 and higher. To check the enhanced connector version, see step 5(a) of [enhanced connector installation instructions](workfront-connector-install.md). 
>
