...
| Add new assets | <ul> <li>[Upload new assets and folders](/help/assets/add-delete.md#add-assets)</li> <li>[Monitor upload progress and manage uploads](/help/assets/add-delete-assets-view.md#upload-progress)</li> <li>[Resolve duplicates](/help/assets/add-delete-assets-view.md#resolve-upload-fails)</li> </ul> |
