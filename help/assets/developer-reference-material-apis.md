...
### Example Shell Script to upload assets to AEM CloudService {#upload-assets-shell-script}

The multistep upload process for direct binary access within AEMaaCS is illustrated in the following example shell-script "aem-upload.sh":
