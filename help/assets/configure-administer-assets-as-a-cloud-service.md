...
The article lists the top-level configuration or administration tasks required to get started using Adobe Experience Manager Assets as a Cloud Service.
