  ...
  + Cloud Transition Tools {#cloud-migration}
    ...
    + Content Transfer Tool {#content-transfer-tool}
      ...
      + Legacy Content Transfer Tool {#legacy}
        + [Overview](/help/journey-migration/content-transfer-tool/ctt-legacy/using-content-transfer-tool/overview-content-transfer-tool.md)
        + [Prerequisites for Content Transfer Tool](/help/journey-migration/content-transfer-tool/ctt-legacy/using-content-transfer-tool/prerequisites-content-transfer-tool.md)
        + [Guidelines and Best Practices for Using Content Transfer Tool](/help/journey-migration/content-transfer-tool/ctt-legacy/using-content-transfer-tool/guidelines-best-practices-content-transfer-tool.md)
        + [Getting Started with Content Transfer Tool](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/ctt-legacy/getting-started-content-transfer-tool.md)
        + [Validating Content Transfers](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/ctt-legacy/validating-content-transfers.md)
        + [Handling Large Content Repositories](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/ctt-legacy/handling-large-content-repositories.md)
        + [Extracting Content from Source](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/ctt-legacy/extracting-content.md)
        + [Ingesting Content into Target](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/ctt-legacy/ingesting-content.md)
        + [Viewing Logs for a Migration Set](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/ctt-legacy/viewing-logs.md)
        + [Deleting a Migration Set](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/ctt-legacy/deleting-migrationset.md)
        + [Running the Content Transfer Tool on a Publish Instance](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/ctt-legacy/running-content-transfer-tool-publish-instance.md)
        + [Troubleshooting Content Transfer Tool](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/ctt-legacy/troubleshooting-content-transfer-tool.md)
