...
+ AEM as a Cloud Service Migration Journey {#migration-journey}
  ...
  + Cloud Transition Tools {#cloud-migration}
    ...
    + Content Transfer Tool {#content-transfer-tool}
      ...
      + Legacy User Mapping Tool (Legacy) {#user-mapping-tool}
        + [Overview](/help/journey-migration/content-transfer-tool/user-mapping-tool/overview-user-mapping-tool-legacy.md)
        + [Important Considerations](/help/journey-migration/content-transfer-tool/user-mapping-tool/considerations-user-mapping-tool-legacy.md)
        + [Using User Mapping Tool](/help/journey-migration/content-transfer-tool/user-mapping-tool/using-user-mapping-tool-legacy.md)
