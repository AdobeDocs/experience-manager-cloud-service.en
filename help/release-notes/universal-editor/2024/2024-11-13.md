...
* **Extensibility Enhancements for Developers:** The Universal Editor now supports  broadcasting events to extensions, allowing extension developers to subscribe to [events](/help/implementing/universal-editor/events-universal-editor.md).
  * This enables developers to [react to editor events within their custom extensions](/help/implementing/universal-editor/extending.md).
