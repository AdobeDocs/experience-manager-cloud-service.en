...
* **Duplicate Components**: A new toolbar button lets authors duplicate content with a single click, making it quick and efficient to create similar blocks by copying, modifying, and repositioning existing elements, simplifying repetitive content creation.
