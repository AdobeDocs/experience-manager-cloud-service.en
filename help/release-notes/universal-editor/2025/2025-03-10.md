...
A number of new [extensions for the Universal Editor](/help/implementing/universal-editor/extending.md) have been released on [Extension Manager,](https://developer.adobe.com/uix/docs/extension-manager/)  enhancing the authoring experience.

* **[AEM Multi-Site-Management (MSM) Extension](/help/sites-cloud/authoring/universal-editor/authoring.md#inheritance)**: You can now break and re-instantiate inheritance of components/blocks using this extension.
* **[AEM Page Properties Extension](/help/sites-cloud/authoring/universal-editor/authoring.md#page-properties)**: Access the page properties window of the page directly from the Universal Editor using this extension.
* **[AEM Workflows Extension](/help/sites-cloud/authoring/universal-editor/authoring.md#workflows)**: Use workflows on pages and Content Fragments which are instrumented on the page using this extension.
* **[AEM Page Lock Extension](/help/sites-cloud/authoring/universal-editor/authoring.md#locking-pages)**: Use this extension to lock and unlock a page directly from the Universal Editor.
