...
* SITES-20594: Return full name of user creating/modifying/replicating a resource
...
* SITES-20946: Add etag as property in LIST models endpoint
...
* ASSETS-30379: DRM Licence check walks entire tree of assets being downloaded
...
* SITES-21391: [OpenAPI Event] No events triggered when modifying title or tags (properties) of a Content Fragment Model
...
* SITES-19994: Close button clocking when user try to close Content Fragment.
