...
### Embedded Technologies {#embedded-tech-26309}
...
>[!IMPORTANT]
>
>This release upgrades the Java Runtime Environment to version 21.0.10 ([Release Notes](https://www.oracle.com/java/technologies/javase/21-0-10-relnotes.html))
>This upgrade disables the `TLS_RSA` cipher suites as they do not preserve forward-secrecy.
>Attempts to access external systems from AEM using cipher suites starting with `TLS_RSA_` will fail with an `SSLHandshakeException`.
