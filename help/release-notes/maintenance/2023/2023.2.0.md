...
- SITES-13636 - Issue reported where some custoemrs are missing the clientlib dependencies of the image and carousel site clientlib. The dependency is not getting resolved, in case a customers embeded another clientlib which incliudes the image or carousel clienlib.
- SITES-13475 - Issue with backward compatilibity break for PanelContainer.js in 2.22.10 Core Components Version.
