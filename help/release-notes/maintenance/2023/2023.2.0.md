...
- SITES-13636 - Issue reported where some customers are missing the clientlib dependencies of the image and carousel site clientlib. The dependency is not getting resolved, in case a customer embeded another clientlib which includes the image or carousel clienlib.
