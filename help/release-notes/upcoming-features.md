---
title: Trying Upcoming Features of AEM as a Cloud Service
description: Learn about Adobe Experience Manager as a Cloud Service's release schedule and how to plan for and test upcoming features.
feature: Release Information
role: Admin
---

# Trying New Features of AEM as a Cloud Service {#upcoming-features}

Learn about Adobe Experience Manager as a Cloud Service's release schedule and how to plan for and test upcoming features.

## Introduction {#introduction}

Adobe Experience Manager as a Cloud Service delivers new features on a regular cadence, according to the [Experience Manager releases roadmap.](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap.html#aem-as-cloud-service) These releases include new features that are production-ready and upcoming features that are still in development that we welcome you to try and give us your feedback. The list of new features in a release as well as upcoming features for a given feature release is posted within the [release notes.](/help/release-notes/release-notes-cloud/release-notes-current.md)
...
![Upcoming features cadence graphic](assets/prerelease-cadence.png)
...
Effectively taking advantage of the upcoming features requires four steps.
