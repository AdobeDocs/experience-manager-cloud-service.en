---
title: Release Notes for 2026.6.0 release of [!DNL Adobe Experience Manager] as a Cloud Service.
description: Release Notes for 2026.6.0 release of [!DNL Adobe Experience Manager] as a Cloud Service.
feature: Release Information
role: Admin
---
# 2026.6.0 Release Notes for [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

The following section outlines the feature release notes for the 2026.6.0 version of [!DNL Experience Manager] as a Cloud Service.
...
HTML5 Forms render your existing XFA-based form templates in HTML5 so they work on modern browsers and mobile devices, with support for accessibility, right-to-left languages, attachments, and draft saving. For more information, see [Introduction to HTML5 forms](/help/forms/introductionhtml5.md).
