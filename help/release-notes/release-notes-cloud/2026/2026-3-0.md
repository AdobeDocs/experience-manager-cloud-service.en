---
title: Release Notes for 2026.3.0 release of [!DNL Adobe Experience Manager] as a Cloud Service.
description: Release Notes for 2026.3.0 release of [!DNL Adobe Experience Manager] as a Cloud Service.
feature: Release Information
role: Admin
exl-id: 642a8573-d65f-400a-a24a-80f71bec5636
---
# 2026.3.0 Release Notes for [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

The following section outlines the feature release notes for the 2026.3.0 version of [!DNL Experience Manager] as a Cloud Service.
