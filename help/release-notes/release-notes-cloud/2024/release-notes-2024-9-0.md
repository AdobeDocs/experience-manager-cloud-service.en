...
Declare [browser redirects](/help/implementing/dispatcher/cdn-configuring-traffic.md#server-side-redirectors) in a configuration file Git that are deployed to and evaluated at the CDN. This can be useful for scenarios including deleting pages, changed site structure, and SEO optimization.
