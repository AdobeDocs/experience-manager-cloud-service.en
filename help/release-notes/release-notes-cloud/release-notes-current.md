...
The release date of [!DNL Adobe Experience Manager] as a [!DNL Cloud Service] current feature release (2025.5.0) is May 29, 2025. The next feature release (2025.6.0) is planned for June 26, 2025.
