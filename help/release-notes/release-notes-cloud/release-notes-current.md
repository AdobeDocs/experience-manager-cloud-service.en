...
* **Forms Portal**: You can use [Forms Portal](../../forms/configure-forms-portal.md) to list your published adaptive forms on an AEM Sites page. It helps a site vistor discover all available forms. Moreover, the visitor can use forms portal to save and access draft of an adaptive form and look at the PDF version of a submitted adaptive form.  
