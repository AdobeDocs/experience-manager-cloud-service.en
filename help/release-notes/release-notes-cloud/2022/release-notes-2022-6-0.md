...
* A new [user interface](/help/sites-cloud/administering/content-fragments/managing.md#content-fragments-console) is now available for content admins and content authors to efficiently manage (such as publish, unpublish, copy, move, and so on), search/filter, and create content fragments for Headless use-cases.
