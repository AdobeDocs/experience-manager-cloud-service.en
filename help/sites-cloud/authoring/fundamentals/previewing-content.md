...
Content may also be published to preview by using a [Publish Content Tree Workflow](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=en#publish-content-tree-workflow) with the agentId parameter set to preview or by using the [replication API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=en#replication-api) with an AgentFilter configured for preview.
