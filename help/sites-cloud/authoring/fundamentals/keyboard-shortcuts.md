...
|---|---|---|
|Any edit window mode|`Ctrl-Shift-m`|Toggle between **Preview** and the currently selected [mode](/help/sites-cloud/authoring/getting-started/page-editor.md#mode-selector) (for example, **Edit**, **Layout**, and so on)*|
|**Edit** mode|`Ctrl-z`|[Undo last change](/help/sites-cloud/authoring/getting-started/edit-content.md)|
||`Ctrl-y`|[Redo last change](/help/sites-cloud/authoring/getting-started/edit-content.md#undoing-and-redoing-page-edits)|
