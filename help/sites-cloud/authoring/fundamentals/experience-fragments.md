...
description: Use Experience Fragments to make your experiences reusable and even more flexible.
seo-description: Use Experience Fragments to make your experiences reusable and even more flexible.
...
1. Define the required properties:
   ...
   ![Variation properties](/help/sites-cloud/authoring/assets/xf-06.png)

1. Confirm with **Done** (tick icon), the new variation will be shown in the panel:

   ![Finished Experience Fragment variation](/help/sites-cloud/authoring/assets/xf-07.png)
...
1. Create an instance of the Experience Fragment component, by dragging the component from the Components browser to the page paragraph system:
   ...
   ![Using the Experience Fragment](/help/sites-cloud/authoring/assets/xf-08.png)
...
1. Add the actual Experience Fragment to the component instance; either:
   ...
   ![Adding an Experience Fragment to a page](/help/sites-cloud/authoring/assets/xf-09.png)
...
1. In the Experience Fragment editor, select the components you want to re-use:
   ...
   ![Select component for Building Block](/help/sites-cloud/authoring/assets/xf-10.png)

1. From the components toolbar, select **Convert to building block**:

   ![Building Block button](/help/sites-cloud/authoring/assets/xf-authoring-13-icon.png)
...
1. When you open the **Properties** of the Experience Fragment:
   ...
   ![Properties button](/help/sites-cloud/authoring/assets/ef-04.png)
...
1. Select **Configuration options**:
   ...
   ![Configuration button](/help/sites-cloud/authoring/assets/ef-02.png)

1. Specify the required templates in the **Configure Experience Fragments** dialog:

   ![Configure Experience Fragments](/help/sites-cloud/authoring/assets/ef-01.png)
