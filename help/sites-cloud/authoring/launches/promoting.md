...
1. Open:
   * The **Sites** console when navigating source pages:
     1. Open the [references rail](/help/sites-cloud/authoring/console/console-side-panel.md#references) and select the required source page using [selection mode](/help/sites-cloud/authoring/getting-started/basic-handling.md) (or select and open the references rail, the order is not important). All references are shown.
