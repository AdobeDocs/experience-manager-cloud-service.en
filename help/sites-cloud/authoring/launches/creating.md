...
* The title appears in the [References](/help/sites-cloud/authoring/console/console-side-panel.md#references) rail, from where authors can access them to work on them.
...
>
>This mechanism can be used to change the template of an [existing page](/help/sites-cloud/authoring/console/organizing-pages.md#creating-a-new-page) - though the loss of content must be considered.
