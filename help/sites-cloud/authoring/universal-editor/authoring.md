...
You can copy and paste components that are within [containers.](/help/implementing/universal-editor/field-types.md#container) This is possible only if the [target container allows the component to be pasted.](/help/implementing/universal-editor/filtering.md)
