...
You can copy and paste components that are within [containers](/help/implementing/universal-editor/field-types.md#container) on the same browser tab. This is possible only if the [target container does not have any filters set.](/help/implementing/universal-editor/filtering.md)
