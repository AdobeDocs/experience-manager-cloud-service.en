...
* When diffing pages created for use with the [Edge Delivery Services,](/help/edge/overview.md) the pages will be shown side-by-side for convenient comparison, but differences will not be highlighted.
