...
|Generate Variations|[Generate Variations](https://www.aem.live/docs/generate-variations) uses generative Artificial Intelligence (AI) to create content variations based on prompts; these prompts are either provided by Adobe or created, and managed, by users.|
