...
|Generate Variations|The Generate Variations app uses generative Artificial Intelligence (AI) to create content variations based on prompts; these prompts are either provided by Adobe or created, and managed, by users.|

<!-- CHECK 2024.3.0 -->
<!--
|Generate Variations|The [Generate Variations](/help/generative-ai/generate-variations.md) app uses generative Artificial Intelligence (AI) to create content variations based on prompts; these prompts are either provided by Adobe or created, and managed, by users.|
-->
