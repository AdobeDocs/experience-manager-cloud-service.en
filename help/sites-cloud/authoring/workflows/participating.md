...
* Your [notification](/help/sites-cloud/authoring/getting-started//help/sites-cloud/authoring/inbox.md) indicator (toolbar) is incremented:

  ![Notification toolbar](/help/sites-cloud/authoring/assets/workflows-notifications.png)

* The item is listed in your notification [Inbox](/help/sites-cloud/authoring/getting-started//help/sites-cloud/authoring/inbox.md):
...
1. Open the **[AEM Inbox](/help/sites-cloud/authoring/getting-started//help/sites-cloud/authoring/inbox.md)**.
