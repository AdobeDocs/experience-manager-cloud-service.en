...
Site themes are simply packages with a logical structure that clearly reflects the purpose of the package content. For a typical front-end project, Adobe recommends a site theme that has the following structure:
