...
Learn how AEM site themes can be used to customize the style and design of your site for traditional AEM authoring projects with publish delivery.
...
Sites created with AEM site templates allow for the easy download, customization, and redeployment of the themes for traditional AEM authoring projects with [publish delivery.](/help/sites-cloud/authoring/author-publish.md)
