...
Adobe provides and AEM Site Template Builder as a set of scripts for creating new site template. [The AEM Site Template Builder is available along with usage documentation on GitHub.](https://github.com/adobe/aem-site-template-builder)
