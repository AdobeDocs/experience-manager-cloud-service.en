...
[Adobe Dynamic Media Classic](https://docs.adobe.com/content/help/en/dynamic-media-classic/using/intro/introduction.html) is a hosted solution for managing, enhancing, publishing, and delivering rich media assets to Web, mobile, email, and Internet-connected displays and print.
...
>[!NOTE]
>
>* Dynamic Media Classic's DHTML viewer platform officially reached end-of-life on January 31, 2014. For more information see the [DHTML viewer end-of-life FAQ](/help/assets/dynamic-media/dhtml-viewer-endoflifefaqs.md).
...
The components you use for this integration are found in the **Dynamic Media Classic** component area in [Design mode.](/help/sites-cloud/authoring/fundamentals/components.md)
...
The components you use for Dynamic Media are found in the **[!UICONTROL Dynamic Media]** component area in [Design mode](/help/sites-cloud/authoring/fundamentals/components.md). They include the following:
...
![s7_1-296](/help/sites-cloud/administering/assets/s7_1-296.png)
...
1. Tap **[!UICONTROL Configure now]**.
   ...
   ![s7_1-297](/help/sites-cloud/administering/assets/s7_1-297.png)
...
1. Enter the **[!UICONTROL Company]** name and **[!UICONTROL Root Path]** (this is the published server name together with any path you want to specify; if you do not know the published server name, in Dynamic Media Classic, go to **[!UICONTROL Setup > Application Setup]**.)
   ...
   ![s7_1-298](/help/sites-cloud/administering/assets/s7_1-298.png)
...
1. Navigate to **[!UICONTROL Adobe CQ Dynamic Media Classic Dam Listener]** and select the **[!UICONTROL Enabled]** check box.
   ...
   ![s7_1-299](/help/sites-cloud/administering/assets/s7_1-299.png)
...
1. Navigate to **http://localhost:4502/system/console/configMgr/com.day.cq.dam.scene7.impl.Scene7UploadServiceImpl**.
   ...
   ![s7_1-300](/help/sites-cloud/administering/assets/s7_1-300.png)
...
1. Tap the **[!UICONTROL Advanced]** tab, select the **[!UICONTROL Enable Automatic Upload]** check box, then tap **[!UICONTROL OK]**. You now need to configure the DAM Asset workflow to include uploading to Dynamic Media Classic.
   ...
   ![screen_shot_2018-03-15at52501pm](/help/sites-cloud/administering/assets/s7_1-301.png)
...
1. In the sidekick, navigate to the **[!UICONTROL Workflow]** components, and select **[!UICONTROL Dynamic Media Classic]**. Drag **[!UICONTROL Dynamic Media Classic]** to the workflow and tap **[!UICONTROL Save]**. Assets added to AEM Assets in the target folder will automatically be uploaded to Dynamic Media Classic.
   ...
   ![s7_1-301](/help/sites-cloud/administering/assets/s7_1-302.png)
...
1. Tap the **[!UICONTROL Advanced]** tab. In the **[!UICONTROL Enable Secure View]** drop-down menu, select **[!UICONTROL Upon AEM Publish Activation]** to push assets to Dynamic Media Classic without publishing. (By default, this value is set to **[!UICONTROL Immediately]**, where Dynamic Media Classic assets are published immediately.)
   ...
   ![s7_1-302](/help/sites-cloud/administering/assets/s7_1-303.png)
...
1. In the **[!UICONTROL Adobe Dynamic Media Classic]** drop-down list, select the desired configuration and tap **[!UICONTROL OK]**.
   ...
   ![s7_1-303](/help/sites-cloud/administering/assets/s7_1-304.png)
...
1. In the **[!UICONTROL General]** tab, select the **[!UICONTROL Default Configuration]** check box to make this the default company and root path that appears in the Dynamic Media Classic content browser.
   ...
   ![s7_1-304](/help/sites-cloud/administering/assets/s7_1-305.png)
...
1. Tap the **[!UICONTROL Advanced]** tab. In the **[!UICONTROL Ad-hoc Folder]** field, you can modify the **Ad-hoc** folder. By default, it is the **name_of_the_company/CQ5_adhoc**.
   ...
   ![s7_1-305](/help/sites-cloud/administering/assets/s7_1-306.png)

### Configuring universal presets {#configuring-universal-presets}

To configure Universal Presets for the video component, see [Video](/help/sites-cloud/administering/manage-assets-classic-s7-video.md).
...
* Ensure that you used the correct video component. Dynamic Media Classic video component is different than the foundation Video component. See [Foundation Video Component versus Dynamic Media Classic Video Component](/help/sites-cloud/administering/manage-assets-classic-s7-video.md).
