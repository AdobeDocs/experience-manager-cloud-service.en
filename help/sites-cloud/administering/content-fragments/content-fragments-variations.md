...
description: Learn how variations let you author content for the fragment, then create variations of that content according to the purpose. This provides added flexibility for both headless delivery and page authoring.
...
[Variations](/help/sites-cloud/administering/content-fragments/content-fragments.md#constituent-parts-of-a-content-fragment) are a significant feature of Adobe Experience Manager's (AEM) content fragments. They let you create and edit copies of the master content for use on specific channels and scenarios, making both page authoring and headless content delivery even more flexible.
...
When you open your content fragment for editing, the **Variations** tab is opened by default. Here you can author the content, for Master or any variations you have. The structured fragment contains fields of various data types that were defined in the content model. 
...
>[!NOTE]
>
>For full information, see [Markdown](/help/sites-cloud/administering/content-fragments/content-fragments-markdown.md).
...
1. Close the full-screen editor, annotations are still highlighted. If selected, a dialog box opens so that you can edit the annotation more.
...
* Indicated by the highlight on the text, in both full-screen and normal mode of the editor. Full details of an annotation can then be viewed, edited, or deleted, by clicking the highlighted text, which reopens the dialog box.
...
* They can be listed, and deleted, by selecting the **Annotations** tab in the fragment editor.

  ![annotations](assets/cfm-variations-08.png)

* They can be viewed, and deleted, in the [Timeline](/help/sites-cloud/administering/content-fragments/content-fragments-managing.md#timeline-for-content-fragments) for the selected fragment.
...
1. Use the **Insert Asset** icon to open the search dialog box.
...
1. Use the **Insert Content Fragment** icon to open the search dialog box.
...
>title="Variations - Authoring Fragment Content"
>abstract="Learn how to make variations of content for use with specific channels."
...
Variations allow you to take the **Master** content and vary it according to purpose (if necessary).
...
You can edit the variation content after either:
...
1. Confirm the **Delete** action in the dialog box.
...
>
>Synchronization only works on the **Multiline text** data type.
>
