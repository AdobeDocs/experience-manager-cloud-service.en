...
>[!NOTE]
>
>For further details start with [content restoration](/help/operations/restore.md), [Indexing](/help/operations/indexing.md), and [other Maintenance Tasks](/help/operations/maintenance.md).
