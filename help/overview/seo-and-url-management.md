...
>[!NOTE]
>
>The `sling:alias` property can be set using the [Alias property when editing Page Properties](/help/sites-cloud/authoring/console/page-properties.md#advanced).
