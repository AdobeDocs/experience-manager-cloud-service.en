...
`AGENTS.md` is a Markdown file at the root of your AEM project that AI coding tools load automatically at the start of every session in order to be grounded with essential AEM Cloud Service domain expertise (and not other AEM solutions such as AEM 6.5 or Edge Delivery Services). It provides:
