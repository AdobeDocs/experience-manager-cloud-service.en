...
`AGENTS.md` is a Markdown file at the root of your AEM project that AI coding tools load automatically at the start of every session in order to be grounded with essential AEM Cloud Service Java-stack domain expertise (and not other AEM solutions such as AEM 6.5 or Edge Delivery Services). It provides:
...
# Install the ensure-agents-md and create-component skills
/plugin install aem-cloud-service-create-component@adobe-skills

# Install the dispatcher skill
...
```bash
# Install ensure-agents-md and create-component
npx skills add https://github.com/adobe/skills/tree/beta/skills/aem/cloud-service --all

# Install the dispatcher skill
npx skills add https://github.com/adobe/skills/tree/beta/skills/aem/cloud-service/skills/dispatcher --all
```
...
Install `com.adobe.aem:com.adobe.aem.mcp-server-contribs-content` (location TBD) into your local Quickstart using Package Manager at `/crx/packmgr`.
