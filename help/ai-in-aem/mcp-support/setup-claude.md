...
exl-id: f17ede73-2fb8-48a4-b3ff-194b631726a9
---
...
![The Claude Settings dialog.](assets/claude-1.png)

![The Connectors panel in Claude.](assets/claude-2.png)

![Adding a custom connector in Claude.](assets/claude-3.png)

![Connecting the custom connector in Claude.](assets/claude-4.png)

![The custom connector configuration form in Claude.](assets/claude-5.png)

![The Tool permissions dialog for the custom connector.](assets/claude-6.png)

![Prompting Claude to use the AEM Content MCP Service.](assets/claude-7.png)
