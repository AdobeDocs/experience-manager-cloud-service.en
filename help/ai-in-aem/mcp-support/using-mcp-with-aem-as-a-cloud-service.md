...
| **Content (read-only)** | `/content-readonly`  | Read-only content operations (Get, List/Search) for pages, content fragments, and binary assets.                                                                             <br>Send an email to aemagentsteam@adobe.com to get the asset search enabled for you. Include the organization name along with the use case in the email.                                                                                                                                                                                      |
