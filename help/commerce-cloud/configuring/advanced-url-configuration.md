...
It is possible to create [multile category and product pages](/help/commerce-cloud/authoring/multi-template-usage) for only a specific subset of categories or products of a catalog. 
