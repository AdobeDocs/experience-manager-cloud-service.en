...
Adobe's recommendation and reference architecture is to use Edge Delivery Services. The CIF storefront with its AEM CIF Core Components is now in maintenance mode and should not be used in new projects. For reference, please see the [CIF documentation.](/help/commerce-cloud/cif-storefront/cif-introduction.md)
