...
Learn the [AEM Project Structure](/help/implementing/developing/introduction/aem-project-content-package-structure.md) and the characteristics of AEM as a Cloud Service. Adapt your project setup to the AEM as a Cloud Service layout.

Compared to AEM 6.5 deployments, there are two main differences:
...
## Product catalog experiences with AEM rendering {#aem-rendering}
...
## Non-cacheable data and shopping interaction {#non-cacheable}
