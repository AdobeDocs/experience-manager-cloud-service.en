...
## 1. Is CIF GraphQL only used for commerce or will this be available for querying content authored on AEMs JCR? {#faq-1}
...
## 2. Can Product assets (images) be stored and referenced from AEM via Adobe Commerce admin? How can assets from Dynamic Media be consumed? {#faq-2}

There is no official AEM Assets - Adobe Commerce integration available. There is a partner connector available on the [marketplace.](https://commercemarketplace.adobe.com)
...
## 3. Does it matter where the commerce solution is deployed? (On-prem or in the cloud) {#faq-3}
...
## 4. How are catalog pages or product pages created in AEM? How do they persist in AEM? {#faq-4}
...
## 5. When you update product data in your commerce solution, is that a real-time push to AEM? Or is it a batch process? {#faq-5}
...
## 6. What catalog size does AEM with CIF support? {#faq-6}
...
## 7. How does PIM play into this framework? {#faq-7}
...
## 8. Do you also cache pricing and other data via Dispatcher. Does that raise a frequent cache invalidation challenge? {#faq-8}
...
## 9. How does cache invalidation for AEM Dispatcher work with AEM and commerce? {#faq-9}
...
## 10. Is there any recommendation on unified search across AEM content with Commerce? {#faq-10}
...
## 11. How does Search work with AEM and commerce using CIF? {#faq-11}
...
## 12. How can product data be used in MSM or translations? {#faq-12}
...
## 13. Is there a way to enhance the product data with commercial text? Where do you do this? In AEM or in the commerce solution? {#faq-13}
...
## 14. How can PCI compliance be ensured when using AEM for the entire presentation layer? {#faq-14}
...
## 15. If I use AEM and Adobe Commerce cloud versions, is this joint solution PCI compliant? {#faq-15}

Yes, Self-Assessment Questionnaire D and Attestation of Compliance are available on-request.

## 16. How can I request for an I/O Runtime trial license? {#faq-16}
