...
1. Make sure the connection between AEM & Adobe Commerce is working.

1. Create a child configuration of the CIF Cloud Service config following these steps:
...
1. Assign the child configuration to an AEM site.
