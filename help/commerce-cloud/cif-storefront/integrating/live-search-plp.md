...
The PLP component requires the [[!DNL Live Search] Popover CIF component](/help/commerce-cloud/cif-storefront/integrating/live-search-popover.md) to be installed. The PLP widget requires a browser session variable generated by the popover.
