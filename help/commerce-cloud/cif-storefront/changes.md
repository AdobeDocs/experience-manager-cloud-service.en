...
### Previous CIF Versions {#previous-versions-installation}
...
### Previous CIF Versions {#previous-versions-endpoint}

* CIF Classic: Via OSGi configuration in AEM
* CIF Open-source: Via CIF Configuration Browser

## Deployment of CIF Venia Project {#venia-project}

Project available in [Cloud Manager Git Repository](/help/implementing/cloud-manager/managing-code/integrating-with-git.md) and deployment done via [Cloud Manager.](/help/implementing/deploying/overview.md)

### Previous CIF Versions {#previous-versions-venia}
...
## Product Catalog Experiences with AEM Rendering {#catalog-experiences}
