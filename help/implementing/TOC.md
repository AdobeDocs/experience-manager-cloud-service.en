...
+ Developing for AEM as a Cloud Service {#developing}
  ...
  + Headless Experience Management {#headless}
    ...
    + Delivery API {#delivery-api}
      ...
      +  [Authentication for Remote AEM GraphQL Queries on Content Fragments](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/content-fragments/graphql-authentication-content-fragments.html)
