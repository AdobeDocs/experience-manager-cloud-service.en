...
1. In the **Variables Configuration** dialog box, enter the details in the first row of the table.
   ...
   | Step Applied | Required. The step in the pipeline to which the variable applies:<ul><li>**Build** - The variable is applied during the build process.</li><li>**Functional testing** - The variable is used during the functional testing step.</li><li>**UI testing** - The variable is used during the UI testing phase.</li><li<**Deploy** - The variable is used during the deploy step. Use this variable for deployment-time behavior, deployment hooks/scripts, or settings that your Dispatcher/runtime install needs.</li></ul> |
