...
## View Details and Cancel Pipelines {#view-details}

You can view the details of a pipeline to see the status and logs of its last run and also cancel running pipelines.
