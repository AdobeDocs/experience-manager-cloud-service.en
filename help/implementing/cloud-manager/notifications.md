...
[!UICONTROL Cloud Manager] Provides notifications when a production pipeline starts and completes (successfully or unsuccessfully) during a production deployment.
...
The notifications appear in a sidebar within [!UICONTROL Cloud Manager] and throughout the Adobe [!UICONTROL CX Enterprise]. The bell icon in the header displays a badge when you have new notifications.
...
Click a notification or announcement to view its details. Notifications linked to activities such as pipeline deployments take you to the details of that activity such as the pipeline execution window.
...
Click the settings icon at the top of the notifications sidebar to open the **CX Enterprise preferences** window. From here, you can define your notification subscriptions and how you receive notifications.

![Notification settings icon](assets/notifications-configuration.png)

### Subscriptions {#subscriptions}

Subscriptions define the products for which you receive notifications and which types of notifications you receive.

![Notification subscriptions](assets/notifications-subscriptions.png)

By default, you receive all notifications for all products both in the application and by email. Click the chevron next to a product name to display the detailed options and define the types of notifications you receive for that product. Or check or uncheck the options at the product level to select/deselect all options for the product.

![Notification subscription customization](assets/notifications-subscriptions-customize.png)

### Priority {#priority}

Priority alerts are marked with a **HIGH** label. You can configure them to be received as alerts. In the **Priority** section, you can define which categories qualify as priority notifications.

![Notification priority](assets/notifications-priority.png)

Use the drop-down menu to add to the list of categories that qualify as priority. Click the delete icon next to the category names to remove them.
...
* **Duration** - Defines how long the alert remains on the screen if you have not configured them to persist.

### Emails {#emails}

Notifications are available in the web user interface across Adobe [!UICONTROL CX Enterprise] solutions. To opt for these notifications to be sent through email, use the **Emails** section.
