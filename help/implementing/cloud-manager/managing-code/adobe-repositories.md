...
1. From the **Program Overview** page, in the side menu, click ![Folder icon](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Folder_18_N.svg) **Repositories** tab. to switch to the **Repositories** page.
...
1. In the respective text fields, enter the following:
   ...
   * **Repository URL preview** - You do not need to enter a URL path or edit the existing path because the infrastructure is already in place and fully integrated and managed by Adobe.
