...
badge: label="Beta" type="Positive" url="/help/implementing/cloud-manager/release-notes/current.md#manage-access-tokens"
...
>[!NOTE]
>
>The features described in this article are only available through the Beta program. For more details and to sign up for the Beta, see [Bring Your Own Git](/help/implementing/cloud-manager/release-notes/current.md#gitlab-bitbucket).
