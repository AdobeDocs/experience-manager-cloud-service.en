...
Cloud Manager lets you retrieve your repository access information for Adobe-managed repositories using **Access Repo Info** from the **Pipelines** card.  
...
1. To access the password, you must generate a new one. In the **Repository Info** dialog box, select **Generate password**.
...
1. To the right of the **Password** field, click ![Copy icon](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Copy_18_N.svg) to copy the password to the clipboard.
   ...
   * Cloud Manager does not save the password. Save the password securely.
   * Because Cloud Manager does not save the password, if you misplace it, you must generate a new one.
...
Using these credentials, you can clone a local copy of the repository, make changes in that local repository, and, when complete, commit any code changes back to the remote code repository in Cloud Manager.
...
To do so, [create a support ticket for this request](https://experienceleague.adobe.com/?support-solution=Experience+Manager&support-tab=home#support). The ticket is processed with high priority and the password is usually revoked within 24 hours.
