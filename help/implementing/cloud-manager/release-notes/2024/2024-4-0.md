...
description: Release notes for Cloud Manager 2024.4.0 in AEM as a Cloud Service.
...
The release date for Cloud Manager release 2024.4.0 in AEM as a Cloud Service is April 10, 2024. The next release is planned for May 9, 2024.

## What's new {#what-is-new}

* The deletion operation has been improved for [Edge Delivery](/help/edge/overview.md) websites by updating the domain mappings from the program that is related to that site.
