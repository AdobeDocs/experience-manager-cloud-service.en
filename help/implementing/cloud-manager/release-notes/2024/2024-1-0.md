...
The release date for Cloud Manager release 2024.1.0 in AEM as a Cloud Service is January 10, 2024. The next release is planned for February 16, 2024.
...
### Client-Side Collection via Operational Telemetry {#operational-telemetry}

You can leverage the [Operational Telemetry Service](/help/implementing/cloud-manager/content-requests.md#cliendside-collection) to enable client-side collection for AEM as a Cloud Service.
...
* The private beta program is limited to development environments only.
* Availability of the private beta program of this feature is limited.
* This feature is for recovering accidentally deleted content and is not intended for disaster recovery.

### Experience Audit Dashboard {#experience-audit-dashboard}

[The Cloud Manager Experience Audit dashboard](/help/implementing/cloud-manager/reports/report-experience-audit.md) includes a trended view of your page performance scores along with insights and recommendations to help you improve them. Experience Audit is included as a step in the Cloud Manager production pipeline.
...
* An error was fixed where configuration pipelines failed at the build step with an unclear message if configuration file locations were improperly set. The new error message now indicates that the user should check that the location of the configuration files is correct.
