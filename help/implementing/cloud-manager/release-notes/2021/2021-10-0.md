...
* A user in the Deployment Manager role can now delete the Production pipeline in a self-service manner through the UI.

* Add and edit pipeline experiences have been refreshed to use familiar, modern modals.

* Users of Cloud Manager can now submit feedback directly from the user interface through the **Feedback** button on top right of the landing page.
