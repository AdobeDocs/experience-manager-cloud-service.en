...
* Users can now see their Cloud Manager roles by selecting the 'View Cloud Manager roles' option after navigating to the User Profile icon (top right) of CX Enterprise. 
