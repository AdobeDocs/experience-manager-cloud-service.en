...
>
>Non-Selenium containers should execute tests using the HTTP proxy sidecar based on the environment variables in the [UI Testing Section.](/help/implementing/cloud-manager/ui-testing.md#custom-ui-testing)
