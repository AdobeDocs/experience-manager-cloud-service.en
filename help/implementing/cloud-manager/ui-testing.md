...
UI tests are packaged in a Docker image in order to allow a wide choice in language and frameworks (such as Cypress.IO, Selenium, Java and Maven, and Javascript). Additionally, a UI tests project can easily be generated by using [the AEM Project Archetype.](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html)

Adobe encourages the usage of Cypress.IO, as it offers real-time reloading and automatic waiting, which helps save time and improves productivity during testing. Cypress.IO also provides a simple and intuitive syntax, making it easy to learn and use, even for those who are new to testing.
