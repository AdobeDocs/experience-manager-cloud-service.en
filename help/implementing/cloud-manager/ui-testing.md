...
UI tests are packaged in a Docker image in order to allow a wide choice in language and frameworks (such as Cypress, Selenium, Java and Maven, and Javascript). Additionally, a UI tests project can easily be generated by using [the AEM Project Archetype.](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html)
...
>
>For details, please refer to the [AEM Test Samples repository](https://github.com/adobe/aem-test-samples/blob/aem-cloud/ui-cypress/test-module/README.md).
