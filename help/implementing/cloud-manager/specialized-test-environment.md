...
1. In the **Add environment** dialog box, do the following:
   ...
   * Select a **Primary region** from the drop-down list. Once created, the primary region of the Specialized Testing Environment (for example, *United Kingdom (South)*) is locked and cannot be changed.
