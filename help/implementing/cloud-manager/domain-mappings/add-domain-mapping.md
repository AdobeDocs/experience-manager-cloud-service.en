...
1. In the **Map Domain to CDN** dialog box, select your CDN type and associated configuration by selecting one of the following:
...
1. In the **Domain** field, enter the customer-facing hostname you want to serve (for example, `www.example.com`) 
