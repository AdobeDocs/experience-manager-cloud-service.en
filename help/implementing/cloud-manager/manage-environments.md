...
Once activated, you can publish content to the preview service by using the Manage Publication UI inside AEM. See [Previewing Content](/help/sites-cloud/authoring/sites-console/previewing-content.md) for more details.
