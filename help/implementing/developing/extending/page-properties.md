...
Every page has a set of [properties](/help/sites-cloud/authoring/console/page-properties.md) that can be viewed and edited by users. Some are required when creating the page (create view), others can be viewed and edited (edit view) at a later stage. These page properties are defined and made available by the dialog (`cq:dialog`) of the appropriate page component.
...
For example, by default the [**Create Page** wizard](/help/sites-cloud/authoring/console/organizing-pages.md#creating-a-new-page) shows the fields grouped under **More Titles and Description**. To hide these you configure:
