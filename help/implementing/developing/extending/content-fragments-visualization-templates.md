...
| Template renders nothing | Empty page or blank output | Check for unclosed `{{#if}}` or `{{#each}}` blocks; add diagnostic output: `hasFields: {{hasFields}} \| title: {{properties.title}}` |
