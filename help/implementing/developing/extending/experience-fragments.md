...
It is recommended to configure the rewriter using an overlay. See [Overlays in AEM as a Cloud Service](/help/implementing/developing/introduction/overlays.md)
