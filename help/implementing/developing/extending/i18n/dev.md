...
For an overview of the internationalization and localization process, see [Internationalizing Components](/help/implementing/developing/extending/i18n/components.md).
...
The `granite.utils` [client library folder](/help/implementing/developing/introduction/clientlibs.md) provides the JavaScript API. To use the API, include this client library folder on your page. Localization functions use the `Granite.I18n` namespace.
