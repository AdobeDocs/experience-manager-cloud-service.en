...
A package can consist of the following data:
...
To grant users the right to create, modify, upload, and install packages, they must have the appropriate permissions for the following locations:
