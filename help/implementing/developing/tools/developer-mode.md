...
When editing pages in AEM, several [modes](/help/sites-cloud/authoring/console/sites-console.md#page-modes) are available, including Developer mode. Developer mode opens a side panel with several tabs that provide a developer with technical information about the current page.
...
* **[Components](#components)** - This shows a component tree, similar to the [content tree](/help/sites-cloud/authoring/editor/editor-site-panel.md#content-tree) for authors
