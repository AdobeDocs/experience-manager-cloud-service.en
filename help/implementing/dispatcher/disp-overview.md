...
**Legacy mode** - for details around the folder structure and local validation for Legacy mode, see [Validating and Debugging using Dispatcher Tools (Legacy)](dispatcher/validation-debug-legacy.md)
