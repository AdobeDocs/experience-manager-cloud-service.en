...
|`data-editor-behavior`|Defines the behavior of an instrumentation, for example, stand alone text or image can also mimic a component to make it moveable or deletable|
